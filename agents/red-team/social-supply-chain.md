...
2. Every finding follows `skills/attack-hypothesis/SKILL.md`. Include the optional `Sink:` field (e.g. `outbound email from-header`, `csv export`, `npm install hook`, `docker build step`).
